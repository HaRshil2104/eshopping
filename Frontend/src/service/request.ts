...
request.interceptors.request.use(
  async (config: any) => {
    if (config.headers) {
      ...
      config.headers["Access-Control-Allow-Method"] = "GET";
      config.headers["Access-Control-Allow-Method"] = "POST";
      config.headers["Access-Control-Allow-Method"] = "PUT";
      config.headers["Access-Control-Allow-Method"] = "DELETE";
    }
