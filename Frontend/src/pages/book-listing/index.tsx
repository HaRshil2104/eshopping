    ...
    <div className={classes.productListWrapper}>
      <div className="container">
            ...
            {books.map((book: BookModel) => (
              <div className="product-list">
                <div className="product-list-inner">
                  <em>
                    <img src={book.base64image} className="image" alt="dummy-image" />
                  </em>
                  <div className="content-wrapper">
                    ...
                    <button className="MuiButtonBase-root MuiButton-root MuiButton-contained btn pink-btn MuiButton-containedPrimary MuiButton-disableElevation">
                      <span className="MuiButton-label" onClick={() => addToCart(book)}>ADD TO CART</span>
        ...
        <div className="pagination-wrapper">
          <Pagination count={Math.ceil((bookList?.records.length ? bookList.totalRecords : 0)/10)}
